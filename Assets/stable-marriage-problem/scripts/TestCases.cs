...
public class TestCases
{
    ...
    public static Tuple<Person[], Person[]> TestCase01() {
        ...
        m1.preferences = new List<Person>() { w2, w1, w3 }; w1.preferences = new List<Person>() { m3, m2, m1 };
        m2.preferences = new List<Person>() { w2, w3, w1 }; w2.preferences = new List<Person>() { m1, m2, m3 };
        m3.preferences = new List<Person>() { w2, w3, w1 }; w3.preferences = new List<Person>() { m1, m3, m2 };
